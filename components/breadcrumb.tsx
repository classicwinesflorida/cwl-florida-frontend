...
export default function Breadcrumb() {
  ...
  const generateBreadcrumbs = (): BreadcrumbItem[] => {
    ...
    const aiToolPages = Object.keys(pathLabels).filter(page => 
      pathLabels[page] !== '' && !excludedPages.includes(page)
    );
    const isAiToolPage = pathSegments.some(segment => aiToolPages.includes(segment));
